...
import { openTelegramLink, openCoachingBooking } from '../../utils/externalLinks';
      ...
      <ScrollView style={styles.container} contentContainerStyle={styles.content}>
        ...
        {!premium && (
          <Card style={styles.coachingCard}>
            <Text style={[styles.coachingTitle, { color: c.text.primary }]}>Premium Feature</Text>
            <Text style={[styles.coachingDesc, { color: c.text.secondary }]}>
              Founder coaching is available for premium members. Upgrade to book personalized training sessions.
            </Text>
          </Card>
        )}
        ...
        {/* 1:1 Coaching */}
        <Card style={styles.coachingCard}>
          <Text style={[styles.coachingTitle, { color: c.text.primary }]}>Train with the Founder</Text>
          <Text style={[styles.coachingDesc, { color: c.text.secondary }]}>
            Book a session with the founder for personalized training and nutrition guidance. Available for premium members.
          </Text>
          <TouchableOpacity
