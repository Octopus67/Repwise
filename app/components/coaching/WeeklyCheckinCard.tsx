...
const styles = StyleSheet.create({
  ...
  trendText: { color: colors.text.primary, fontSize: typography.size.base, marginBottom: spacing[1] },
  changeText: { color: colors.text.secondary },
  explanation: { color: colors.text.secondary, fontSize: typography.size.sm, marginBottom: spacing[3] },
  progressBarBg: {
  ...
  progressText: { color: colors.text.muted, fontSize: typography.size.xs },
  ...
  pillLabel: { fontSize: typography.size.xs, fontWeight: typography.weight.medium },
  pillValue: { color: colors.text.primary, fontSize: typography.size.md, fontWeight: typography.weight.bold },
  buttonRow: { flexDirection: 'row', gap: spacing[2] },
  primaryButton: {
    flex: 1, backgroundColor: colors.accent.primary, paddingVertical: spacing[2],
    borderRadius: radius.sm, alignItems: 'center',
  },
  primaryButtonText: { color: colors.text.inverse, fontWeight: typography.weight.semibold, fontSize: typography.size.base },
  secondaryButton: {
    flex: 1, borderWidth: 1, borderColor: colors.border.default, paddingVertical: spacing[2],
    borderRadius: radius.sm, alignItems: 'center',
  },
  secondaryButtonText: { color: colors.text.secondary, fontWeight: typography.weight.medium, fontSize: typography.size.base },
  editContainer: { gap: spacing[2] },
  inputRow: { flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between' },
  inputLabel: { color: colors.text.secondary, fontSize: typography.size.sm },
  input: {
