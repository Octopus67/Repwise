...
const styles = StyleSheet.create({
  ...
  segmentText: {
    color: colors.text.secondary, fontSize: typography.size.sm, fontWeight: typography.weight.medium,
  },
  segmentTextActive: { color: colors.text.inverse, fontWeight: typography.weight.semibold },
  ...
  errorText: {
    color: colors.semantic.negative, fontSize: typography.size.sm,
  ...
  resultCard: {
    ...
    borderWidth: 1, borderColor: colors.accent.primaryMuted,
