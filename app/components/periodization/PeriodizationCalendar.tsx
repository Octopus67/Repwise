...
const getThemedStyles = (c: ThemeColors) => StyleSheet.create({
  ...
  headerBtn: { paddingHorizontal: spacing[3], paddingVertical: spacing[1], borderRadius: radius.full, backgroundColor: c.bg.surfaceRaised, borderWidth: 1, borderColor: c.border.subtle },
  headerBtnText: { color: c.text.secondary, fontSize: typography.size.sm },
  fab: { paddingHorizontal: spacing[3], paddingVertical: spacing[1], borderRadius: radius.full, backgroundColor: c.accent.primaryMuted, borderWidth: 1, borderColor: c.accent.primary },
  fabText: { color: c.accent.primary, fontSize: typography.size.sm, fontWeight: typography.weight.medium },
  deloadBanner: { flexDirection: 'row', alignItems: 'center', gap: spacing[2], backgroundColor: c.semantic.warningSubtle, borderRadius: radius.sm, padding: spacing[3], marginBottom: spacing[2] },
  deloadText: { color: c.semantic.warning, fontSize: typography.size.sm },
  weekRow: { flexDirection: 'row', borderBottomWidth: 1, borderBottomColor: c.border.subtle, paddingVertical: spacing[2] },
  currentWeek: { backgroundColor: c.accent.primaryMuted, borderRadius: radius.sm },
  ...
  blockName: { color: c.text.primary, fontSize: typography.size.base, fontWeight: typography.weight.medium, flex: 1 },
  nutritionBadge: { backgroundColor: c.bg.surfaceRaised, paddingHorizontal: spacing[2], paddingVertical: 2, borderRadius: radius.full },
  nutritionText: { color: c.text.secondary, fontSize: typography.size.xs },
  weekLabel: { color: c.text.muted, fontSize: typography.size.xs, marginTop: 2 },
  dots: { flexDirection: 'row', gap: 4, marginTop: 4 },
  dot: { width: 6, height: 6, borderRadius: 3, backgroundColor: c.accent.primary },
});
