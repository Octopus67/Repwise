...
- [-] 0.5: Git commit baseline: `git add -A && git commit -m "baseline before training-workflow-redesign"`
...
- [~] FINAL.5: Verify animation coverage: >= 50% of exercises have non-null animation_url
