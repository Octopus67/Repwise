...
CMD gunicorn src.main:app -w ${WEB_CONCURRENCY:-1} -k uvicorn.workers.UvicornWorker --bind 0.0.0.0:${PORT:-8000} --proxy-headers --forwarded-allow-ips='*' --timeout 120 --graceful-timeout 30 --keep-alive 5
