...
# Set the SQLAlchemy URL from application settings so we have a single
...
# MetaData object for 'autogenerate' support — Alembic compares this
# against the database to produce migration diffs.
