...
_DEFS: list[AchievementDef] = [
    ...
    AchievementDef(
        id="pr_bench_1plate",
        category=AchievementCategory.PR_BADGE,
        title="1-Plate Bench",
        description="Bench press 60 kg",
        icon="badge-bench-1",
        threshold=60,
        exercise_group="bench_press",
    ),
    AchievementDef(
        id="pr_bench_2plate",
        category=AchievementCategory.PR_BADGE,
    ...
    AchievementDef(
        id="pr_deadlift_2plate",
        category=AchievementCategory.PR_BADGE,
        title="2-Plate Deadlift",
        description="Deadlift 100 kg",
        icon="badge-dl-2",
        threshold=100,
        exercise_group="deadlift",
    ),
    AchievementDef(
        id="pr_deadlift_3plate",
        category=AchievementCategory.PR_BADGE,
        title="3-Plate Deadlift",
        description="Deadlift 140 kg",
        icon="badge-dl-3",
        threshold=140,
        exercise_group="deadlift",
    ),
    AchievementDef(
        id="pr_deadlift_4plate",
        category=AchievementCategory.PR_BADGE,
    ...
    AchievementDef(
        id="pr_deadlift_5plate",
        category=AchievementCategory.PR_BADGE,
        title="5-Plate Deadlift",
        description="Deadlift 220 kg",
        icon="badge-dl-5",
        threshold=220,
        exercise_group="deadlift",
    ),
    ...
    AchievementDef(
        ...
        description="7 consecutive compliant days",
        icon="badge-nutr-7",
        threshold=7,
    ),
    AchievementDef(
        ...
        description="14 consecutive compliant days",
        icon="badge-nutr-14",
        threshold=14,
    ),
    AchievementDef(
        id="nutrition_30",
        category=AchievementCategory.NUTRITION,
        title="Monthly Macro Master",
        description="30 consecutive compliant days",
        icon="badge-nutr-30",
        threshold=30,
    ),
]
